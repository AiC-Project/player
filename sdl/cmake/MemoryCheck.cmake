...
FUNCTION(SETUP_TARGET_FOR_MEMCHECK _targetname _test)
    ...
    COMMENT "Valgrind run complete for test=${_test} valgrind=${VALGRIND_PATH} I=${I} target=${_targetname}"
    # Run tests
    COMMAND ${VALGRIND_PATH} --leak-check=full   --show-reachable=yes
                             --track-fds=yes     --track-origins=yes
                             --log-file="log/log_valgrind.txt"
